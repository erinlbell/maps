...
* [Here](http://startapplabs.github.io/starting-with-ionic/#/) you can find the **_slides_** of the presentation at the geomapapp 2015
* [Here](https://geomapapp2015.herokuapp.com/) you can find a hosted version of the app we are going to build
* You can also **_deploy_** your own copy of the app using this button: [![Deploy to Heroku](https://www.herokucdn.com/deploy/button.png)](https://heroku.com/deploy?template=https://github.com/startapplabs/geomapapp/tree/master)
* This is the ID (`7364750e`) of the geomapapp app on [**_Ionic View_**](http://view.ionic.io/). If you want to test the app in your device, you can follow [these steps](http://blog.ionic.io/view-app-is-alive/) and get the app through Ionic View
* If you are an Android user, you can download the `.apk` [here](https://dl.dropboxusercontent.com/u/30675090/geomapapp/geomapapp.apk)
...
First we need to link this new Ionic project with our reference repo on github. Clone and checkout the **_initial commit_** ([`e37d84e`](https://github.com/startapplabs/geomapapp/commit/e37d84e49b3c46c2c04e2da436e8370e90578e33)) of this repo so we can start working on the app:
- `git clone https://github.com/startapplabs/geomapapp.git`
- `cd geomapapp`
...
- `ionic start geomapapp sidemenu`
- `cd geomapapp`
- `ionic setup sass`
...
This app will have information about Uruguay's Javascript Conference 2015 (geomapapp 2015). To serve that purpose, the content will be the following:
...
The final point of this step is this **_commit_** ([`296941e`](https://github.com/startapplabs/geomapapp/commit/296941e4424e3f3a4b4c0bd8d3b1d9f24e807dc1)). Run `git checkout 296941e` and you will see the implementation of the instructions above.

Serve the app with `ionic serve` and look at the **_Ionic dev server_** running on `http://localhost:8100`. There you will see our geomapapp app with the navigation DONE.
...
If you want to see more details of what we have done, take a look at [this comparison](https://github.com/startapplabs/geomapapp/compare/e8d787b...296941e) between the initial commit ([`e8d787b`](https://github.com/startapplabs/geomapapp/commit/e8d787b489c7f29e2b11a58169be4d16a70e1914)) and the final commit ([`296941e`](https://github.com/startapplabs/geomapapp/commit/296941e4424e3f3a4b4c0bd8d3b1d9f24e807dc1)) of this step.
...
The final point of this step is this **_commit_** ([`fb02948`](https://github.com/startapplabs/geomapapp/commit/fb029480b5d67126ceabf632a608cbd3f2b33dcc)). Run `git checkout fb02948` and you will see the implementation of the instructions above.

Serve the app with `ionic serve` and look at the **_Ionic dev server_** running on `http://localhost:8100`. There, you will see our geomapapp app with the **_speakers view_** DONE.
...
If you want to see more details of what we have done, take a look at [this comparison](https://github.com/startapplabs/geomapapp/compare/296941e...fb02948) between the initial commit ([`296941e`](https://github.com/startapplabs/geomapapp/commit/296941e4424e3f3a4b4c0bd8d3b1d9f24e807dc1)) and the final commit ([`fb02948`](https://github.com/startapplabs/geomapapp/commit/fb029480b5d67126ceabf632a608cbd3f2b33dcc)) of this step.
...
The final point of this step is this **_commit_** ([`7bfcf29`](https://github.com/startapplabs/geomapapp/commit/7bfcf293a82be70489849e58306e80afb5aca697)). Run `git checkout -f 7bfcf29` and you will see the implementation of the instructions above.

Serve the app with `ionic serve` and look at the **_Ionic dev server_** running on `http://localhost:8100`. There, you will see our geomapapp app with the **_venue view_** and its map DONE.
...
If you want to see more details of what we have done, take a look at [this comparison](https://github.com/startapplabs/geomapapp/compare/fb02948...7bfcf29) between the initial commit ([`fb02948`](https://github.com/startapplabs/geomapapp/commit/fb029480b5d67126ceabf632a608cbd3f2b33dcc)) and the final commit ([`7bfcf29`](https://github.com/startapplabs/geomapapp/commit/7bfcf293a82be70489849e58306e80afb5aca697)) of this step.
...
This step corresponds with [this](http://startapplabs.github.io/starting-with-ionic/#/33) slide of the **_presentation_**, and this **_commit_** ([`7bfcf29`](https://github.com/startapplabs/geomapapp/commit/7bfcf293a82be70489849e58306e80afb5aca697)) represents the starting point of this step. Please checkout this commit so we are all on the same page: `git checkout -f 7bfcf29`
...
The final point of this step is this **_commit_** ([`9d797d7`](https://github.com/startapplabs/geomapapp/commit/9d797d7ebad844e8cb376e710c9ac05db3cecf32)). Run `git checkout 9d797d7` and you will see the implementation of the instructions above.

Serve the app with `ionic serve` and look at the **_Ionic dev server_** running on `http://localhost:8100`. There, you will see our geomapapp app with the **_agenda view_** and a tabs component showing both days' schedule.
...
If you want to see more details of what we have done, take a look at [this comparison](https://github.com/startapplabs/geomapapp/compare/7bfcf29...9d797d7) between the initial commit ([`7bfcf29`](https://github.com/startapplabs/geomapapp/commit/7bfcf293a82be70489849e58306e80afb5aca697)) and the final commit ([`9d797d7`](https://github.com/startapplabs/geomapapp/commit/9d797d7ebad844e8cb376e710c9ac05db3cecf32)) of this step.
...
This step corresponds with [this](http://startapplabs.github.io/starting-with-ionic/#/34) slide of the **_presentation_**, and this **_commit_** ([`9d797d7`](https://github.com/startapplabs/geomapapp/commit/9d797d7ebad844e8cb376e710c9ac05db3cecf32)) represents the starting point of this step. Please checkout this commit so we are all on the same page: `git checkout 9d797d7`
...
The final point of this step is this **_commit_** ([`14dd74a`](https://github.com/startapplabs/geomapapp/commit/14dd74ae27b03eaedc518e53663472938d6f6861)). Run `git checkout 14dd74a` and you will see the implementation of the instructions above.

Serve the app with `ionic serve` and look at the **_Ionic dev server_** running on `http://localhost:8100`. There, you will see our geomapapp app with real data for the event.
...
If you want to see more details of what we have done, take a look at [this comparison](https://github.com/startapplabs/geomapapp/compare/9d797d7...14dd74a) between the initial commit ([`9d797d7`](https://github.com/startapplabs/geomapapp/commit/9d797d7ebad844e8cb376e710c9ac05db3cecf32)) and the final commit ([`14dd74a`](https://github.com/startapplabs/geomapapp/commit/14dd74ae27b03eaedc518e53663472938d6f6861)) of this step.
...
The final point of this step is this **_commit_** ([`73cec82`](https://github.com/startapplabs/geomapapp/commit/73cec828737e7f72d8f8d478a80de4aa9c206ed1)). Run `git checkout 73cec82` and you will see the implementation of the instructions above.

Serve the app with `ionic serve` and look at the **_Ionic dev server_** running on `http://localhost:8100`. There, you will see our geomapapp app with the Ionic loader and slide box integrated but as you are accessing the app through the browser, you won't see either the social sharing plugin or the inAppBroswer plugin. You will need to install and test the app in your phone to see those in action.

<img src="https://dl.dropboxusercontent.com/u/30675090/geomapapp/share.png" style="width:45%; margin-right:8%; border:1px solid #ccc;">
<img src="https://dl.dropboxusercontent.com/u/30675090/geomapapp/inAppBrowser.png" style="width:45%; border:1px solid #ccc;">

If you want to see more details of what we have done, take a look at [this comparison](https://github.com/startapplabs/geomapapp/compare/14dd74a...73cec82) between the initial commit ([`14dd74a`](https://github.com/startapplabs/geomapapp/commit/14dd74ae27b03eaedc518e53663472938d6f6861)) and the final commit ([`73cec82`](https://github.com/startapplabs/geomapapp/commit/73cec828737e7f72d8f8d478a80de4aa9c206ed1)) of this step.
...
This step corresponds with [this](http://startapplabs.github.io/starting-with-ionic/#/36) slide of the **_presentation_**, and this **_commit_** ([`73cec82`](https://github.com/startapplabs/geomapapp/commit/73cec828737e7f72d8f8d478a80de4aa9c206ed1)) represents the starting point of this step. Please checkout this commit so we are all on the same page: `git checkout 73cec82`
...
<img src="https://dl.dropboxusercontent.com/u/30675090/geomapapp/sass1.png" style="width:45%; margin-right:8%; border:1px solid #ccc;">
<img src="https://dl.dropboxusercontent.com/u/30675090/geomapapp/sass2.png" style="width:45%; border:1px solid #ccc;">
<img src="https://dl.dropboxusercontent.com/u/30675090/geomapapp/sass3.png" style="width:45%; border:1px solid #ccc;">

The final point of this step is this **_commit_** ([`6eaea0f`](https://github.com/startapplabs/geomapapp/commit/6eaea0f704084d18f7c643f1aed5819136fd7cc3)). Run `git checkout 6eaea0f` and you will see the implementation of the instructions above.

Serve the app with `ionic serve` and look at the **_Ionic dev server_** running on `http://localhost:8100`. There, you will see our geomapapp finished with a professional and polished look.
...
If you want to see more details of what we have done, take a look at [this comparison](https://github.com/startapplabs/geomapapp/compare/73cec82...6eaea0f) between the initial commit ([`73cec82`](https://github.com/startapplabs/geomapapp/commit/73cec828737e7f72d8f8d478a80de4aa9c206ed1)) and the final commit ([`6eaea0f`](https://github.com/startapplabs/geomapapp/commit/6eaea0f704084d18f7c643f1aed5819136fd7cc3)) of this step.
...
=======
# maps
>>>>>>> 9c8acf16cfda6399aa7328e5889d49590761e302
